...
class BpkSplitInput extends Component {
  ...
  handleOnPaste = e => {
    ...
    const pastedData = e.clipboardData.getData('text/plain').slice(0, inputLength - focusedInput).split('');
    ...
    this.focusInput(typeof firstInvalidInputPosition !== 'undefined' ? firstInvalidInputPosition : position);
    this.onInputChange(inputValue);
  };
  handleOnKeyDown = e => {
