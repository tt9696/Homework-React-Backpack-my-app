...
const BpkDataTableHeader = ({
  ...
  const headerClassNames = getClassName('bpk-data-table-column__header', headerClassName);
  const upIconClassNames = getClassName('bpk-data-table-column__sort-icon--up', 'bpk-data-table-column__sort-icon', isSorted && !isSortedDesc && 'bpk-data-table-column__sort-icon--selected');
  const downIconClassNames = getClassName('bpk-data-table-column__sort-icon--down', 'bpk-data-table-column__sort-icon', isSorted && isSortedDesc && 'bpk-data-table-column__sort-icon--selected');
