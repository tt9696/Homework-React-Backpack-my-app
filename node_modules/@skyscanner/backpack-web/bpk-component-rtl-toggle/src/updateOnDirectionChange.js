  ...
  class UpdateOnDirectionChange extends Component {
    componentDidMount() {
      ...
      if (htmlElement instanceof HTMLElement) {
        htmlElement.addEventListener(DIRECTION_CHANGE_EVENT, this.onDirectionChange, false);
      }
    }
    componentWillUnmount() {
      const htmlElement = getHtmlElement();
      if (htmlElement instanceof HTMLElement) {
        htmlElement.removeEventListener(DIRECTION_CHANGE_EVENT, this.onDirectionChange, false);
      }
    }
    onDirectionChange = () => {
      this.forceUpdate();
    ...
    render() {
      return /*#__PURE__*/_jsx(EnhancedComponent, {
        ...this.props
      });
    }
  }
