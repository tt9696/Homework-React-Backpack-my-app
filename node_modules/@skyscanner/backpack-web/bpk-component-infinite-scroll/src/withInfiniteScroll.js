...
const withInfiniteScroll = ComponentToExtend => class WithInfiniteScroll extends Component {
  static propTypes = {
    ...propTypes
  };
  static defaultProps = {
  ...
  fetchItems(config) {
    ...
    return this.props.dataSource.fetchItems(index, elementsPerScroll).then(nextElements => {
      let result = {
        isListFinished: true
      };
      if (nextElements && nextElements.length > 0) {
        ...
        result = {
          ...
          showSeeMore: computeShowSeeMore ? seeMoreAfter === index / elementsPerScroll : this.state.showSeeMore,
  ...
  render() {
    ...
    if (!isListFinished) {
      if (showSeeMore && renderSeeMoreComponent) {
        ...
        loadingOrButton = /*#__PURE__*/_jsx("div", {
          ref: spinner => {
            this.sentinel = spinner;
          },
          className: renderLoadingComponent ? null : getClassNames('bpk-sentinel'),
          children: renderLoadingComponent && renderLoadingComponent()
        });
      }
    }
    return /*#__PURE__*/_jsxs("div", {
      children: [/*#__PURE__*/_jsx(ComponentToExtend, {
        ...rest,
