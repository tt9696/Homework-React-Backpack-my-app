...
const getSpinner = large => large ? /*#__PURE__*/_jsx(BpkLargeSpinner, {
  alignToButton: true
}) : /*#__PURE__*/_jsx(BpkSpinner, {
  alignToButton: true
});
const getEnabledIcon = large => {
  const AlignedIcon = large ? withLargeButtonAlignment(withRtlSupport(ArrowIconLg)) : withButtonAlignment(withRtlSupport(ArrowIconSm));
