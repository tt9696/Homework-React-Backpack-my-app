...
const BpkChartAxis = props => {
  ...
  const ticks = scale.ticks ? scale.ticks(numTicks) : scale.domain().filter((tick, i) => (i - tickOffset) % tickEvery === 0);
  return (
    /*#__PURE__*/
    ...
    _jsxs("g", {
      ...
      ...containerProps,
      ...rest,
      children: [ticks.map((tick, i) => /*#__PURE__*/_jsx("g", {
        transform: `translate(${tickPosition(tick).join(', ')})`,
        children: /*#__PURE__*/_jsx("text", {
          className: getClassName('bpk-chart__axis-tick-text'),
          ...textProps,
          children: tickValue(tick, i)
        })
      }, `${orientation}axis${i.toString()}`)), label && /*#__PURE__*/_jsx("text", {
