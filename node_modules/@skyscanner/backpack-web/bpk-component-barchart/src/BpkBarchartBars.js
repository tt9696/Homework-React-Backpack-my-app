...
const getBarHeight = (point, {
  ...
  const barHeight = height - margin.top - margin.bottom - getYPos(point, {
    yScale,
    yScaleDataKey,
    maxYValue
  });
    ...
    children: data.map((point, i) => {
      ...
      return (
        ...
        _jsx(BarComponent, {
          ...
          onClick: onBarClick ? e => onBarClick(e, {
            point
          }) : null,
          onHover: onBarHover ? e => onBarHover(e, {
            point
          }) : null,
          onFocus: onBarFocus ? e => onBarFocus(e, {
            point
          }) : null,
