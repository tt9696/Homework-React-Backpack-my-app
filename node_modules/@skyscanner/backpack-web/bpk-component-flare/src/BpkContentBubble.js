...
const BpkContentBubble = props => {
  ...
  if (showPointer) {
    wrapperClassNames.push(getClassName('bpk-content-bubble__wrapper--with-pointer'));
  }
  if (rounded) {
    wrapperClassNames.push(getClassName('bpk-content-bubble__wrapper--rounded'));
    if (showPointer) {
      wrapperClassNames.push(getClassName('bpk-content-bubble__wrapper--rounded--with-pointer'));
    }
  }
  if (className) {
